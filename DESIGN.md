...
Identity ring: 8 category tints at fixed L/C (`--tint-*`: red 25, orange 55, amber 85, green 150, teal 195, blue 255, violet 300, pink 345) so every glyph reads as one family; bank tints keep the user's existing identities (Chase blue, Amex green, SoFi orange, HSA grey, Roth violet).
